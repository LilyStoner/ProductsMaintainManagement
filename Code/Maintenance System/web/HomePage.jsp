                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="ComponentWarehouse">
                                <i class="align-middle" data-feather="credit-card"></i> <span class="align-middle">Component</span>
                            </a>
                        </li>

                        <li class="sidebar-item">
                            <a class="sidebar-link" href="customer">
                                <i class="align-middle" data-feather="list"></i> <span class="align-middle">Customer</span>
                            </a>	
                        </li>	
